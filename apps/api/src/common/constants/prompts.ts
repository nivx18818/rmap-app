export const AI_PROMPTS = {
  ...
  getRoadmapGenerationPrompt: (input: {
    ...
    return [
      ...
      '- Group nodes can be nested up to 2 levels deep (Parent Group -> Sub Group -> Leaf). A sub-group (child of another group) MUST contain only leaf nodes; it cannot contain more groups.',
