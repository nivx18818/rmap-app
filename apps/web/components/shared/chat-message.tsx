  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            'relative rounded-md p-2.5 text-sm tracking-normal sm:p-3 sm:text-base',
...
export function ChatLoading() {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-2 flex w-full items-start gap-2.5 duration-300 sm:gap-3">
      ...
      <div className="bg-background-secondary flex items-center gap-1.5 rounded-md px-3 py-2.5 sm:px-4 sm:py-3">
