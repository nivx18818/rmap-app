...
function GoogleIcon() {
  return (
    <svg className="size-5 shrink-0" aria-hidden="true" viewBox="0 0 24 24">
      <path
        fill="#4285F4"
...
function FacebookIcon() {
  return (
    <svg className="size-5 shrink-0" fill="#1877F2" aria-hidden="true" viewBox="0 0 24 24">
...
export function SocialAuthButtons() {
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Social Buttons */}
      <div className="flex flex-col gap-4">
        <Button size="lg" variant="outline" className="w-full gap-2" type="button">
          <GoogleIcon />
