...
| **FR-09** | Milestone project           | Each roadmap includes 2-3 predefined **major milestone projects** (for example for Backend: CRUD API -> Auth System -> Deploy Project). When an unlocked milestone is opened, the system lazily generates and stores an AI test suite from the milestone project brief. Each suite contains exactly 6 Node.js-compatible generated tests and uses an 80% pass threshold. Milestones are highlighted in the roadmap and linked to related skill nodes.                                                                                                                                                             |
