...
| **ID**    | **Function**            | **Detailed Description**                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **FR-13** | Update node status      | Authenticated users move eligible node state on personal roadmaps and templates: `Locked -> In Progress -> Completed`. For leaf nodes, transitioning to `Completed` requires `quiz_passed = true` (score >= 60%). Milestone completion is project/submission-driven. GROUP nodes are not manually completable; the backend auto-completes them through cascade logic. The system records completion timestamp.                                   |
