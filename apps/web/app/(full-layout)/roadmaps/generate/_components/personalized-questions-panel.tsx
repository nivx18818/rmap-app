...
import { usePersonalizedQuestionsChat } from '@/app/(full-layout)/roadmaps/generate/_hooks/use-personalized-questions-chat';
import { ConversationRole } from '@/app/(full-layout)/roadmaps/generate/_types/personalized-questions-chat.types';
      ...
      >
        ...
        {isCompleted && (
          <div className="bg-background-secondary/60 border-border/80 flex items-center gap-2 rounded-md border px-3 py-2 text-sm sm:text-base">
            <HugeiconsIcon className="text-primary size-4 sm:size-5" icon={CheckmarkCircle02Icon} />
