...
| **ID**    | **Function**             | **Detailed Description**                                                                                                                                                                                                                                       |
| --------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **FR-10** | Skill Tree visualization | Use React Flow to display a tree/graph view. Support zoom and pan. Nodes are color-coded by status (Locked / In Progress / Completed). Milestone projects are shown as special nodes, and GROUP nodes are shown as structural spine sections.                  |
...
| **FR-12** | Skill detail (Sidebar)   | Clicking a required, optional, or milestone node opens a sidebar with skill description, resource list (1-2 primary links, prioritize free resources), prerequisites, and related milestone/project details. GROUP nodes do not open the skill detail sidebar. |
...
| **ID**    | **Function**            | **Detailed Description**                                                                                                                                                                                                                                                                                                                                                                               |
| --------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **FR-13** | Update node status      | Users move eligible node state: `Locked -> In Progress -> Completed`. For leaf nodes, transitioning to `Completed` requires `quiz_passed = true` (score >= 60%). Milestone completion is project/submission-driven. GROUP nodes are not manually completable; the backend auto-completes them through cascade logic. The system records completion timestamp.                                          |
| **FR-14** | Three-layer progress    | Roadmap detail displays 3 metrics at once: **(1)** Roadmap completion %, **(2)** Streak - consecutive learning days, **(3)** Skill Readiness for selected goal (calculated from completed important nodes / total important nodes). It also shows completed/total nodes. Example: `Roadmap: 40%`                                                                                                       |
